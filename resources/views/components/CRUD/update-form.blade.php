...
@section('cont')
    ...
    <form class="max-w-sm mx-auto" method="get" action="http://127.0.0.1:8000/books/updateStore/{{$Books->name}}">
        ...
        <div class="mb-5">
            ...
            <input  id="description" name="description"  value=" {{$Books->description}} " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :border-blue-500 " required />
        </div>
        <div class="mb-5">
            <label for="years"  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> год  </label>
            <input  id="years" name="years" value=" {{$Books->years}} " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :border-blue-500  " required />
        </div>
        <div class="mb-5">
            <label for="count"  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">цена </label>
            <input  id="count" name="count"  value=" {{$Books->count}} " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :border-blue-500  " required />
        </div>
